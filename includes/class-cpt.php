	...
	public static function register() {
		register_post_type(self::POST_TYPE, array(
			...
			'labels' => array(
				...
				'all_items' => __('All Previews', 'responsive-theme-preview'),
				'add_new' => __('Add New', 'responsive-theme-preview'),
				'add_new_item' => __('Add New Preview', 'responsive-theme-preview'),
				'edit_item' => __('Edit Preview', 'responsive-theme-preview'),
			),
			'public' => true,
			'publicly_queryable' => true,
			'show_ui' => true,
			'show_in_menu' => 'rtp-previews',
			'show_in_rest' => true,
