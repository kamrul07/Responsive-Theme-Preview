  ...
  registerBlockType("rtp/responsive-preview", {
    ...
    edit: function (props) {
      ...
      function addBreakpoint() {
        const arr = (a.breakpoints || []).slice();
        arr.push({ title: "Custom", width: 1024, icon: "" });
        set({ breakpoints: arr });
      }
      function removeBreakpoint(idx) {
        const arr = (a.breakpoints || []).slice();
        arr.splice(idx, 1);
        set({ breakpoints: arr });
      }
      ...
      function addItem() {
        const arr = (a.itemsArr || []).slice();
        arr.push({ title: "", image: "", url: "", btn: __("Preview", "responsive-theme-preview") });
        set({ itemsArr: arr });
      }
      ...
      return el(
        ...
        el(
          ...
          el(
            PanelBody,
            { title: __("Source", "responsive-theme-preview"), initialOpen: true },
            el(SelectControl, {
            ...
            a.source === "dynamic" &&
              el(
                ...
                el("input", {
                  type: "checkbox",
                  checked: a.enableCategoryFilter || false,
                  onChange: (e) => set({ enableCategoryFilter: e.target.checked }),
                  style: { marginRight: "8px" },
                }),
                el("label", {}, __("Enable Category Filter", "responsive-theme-preview"))
              ),
            a.source === "dynamic" &&
              el(SelectControl, {
            ...
            a.source === "static" &&
              el(
                ...
                (a.itemsArr || []).map(function (item, idx) {
                  return el(
                    "div",
                    { key: idx, style: { border: "1px solid #ddd", padding: "10px", marginBottom: "10px" } },
          ...
          el(
            PanelBody,
            { title: __("Breakpoints", "responsive-theme-preview"), initialOpen: false },
            el(
              "div",
              {},
              (a.breakpoints || []).map(function (bp, idx) {
                return el(
                  "div",
                  { key: idx, style: { border: "1px solid #ddd", padding: "8px", marginBottom: "8px" } },
          ...
          el(
            PanelBody,
            { title: __("CTA & Styles", "responsive-theme-preview"), initialOpen: false },
            ...
            el(SelectControl, {
              ...
              options: [
                ...
                { label: __("Center", "responsive-theme-preview"), value: "pos-center" },
              ],
              onChange: (v) => set({ previewBtnPos: v }),
            }),
            el("div", { style: { marginTop: "8px" } }, el("label", null, __("Overlay Background", "responsive-theme-preview")), el(ColorPalette, { value: a.overlayBg, onChange: (v) => set({ overlayBg: v }) })),
            el("div", { style: { marginTop: "8px" } }, el("label", null, __("Topbar Background", "responsive-theme-preview")), el(ColorPalette, { value: a.topbarBg, onChange: (v) => set({ topbarBg: v }) }))
          )
        ),
